...
class TestRetrievalPipeline(unittest.TestCase):
    def setUp(self):
        ...
        self.mock_index_manager.namespaces = ["basic_sciences", "pharmacology", "clinical_medicine"]
    ...
    def test_rrf_merge_ranking(self):
        ...
        dense_results = [
            ({"text": "Doc A content", "metadata": {"document_name": "Doc A", "geography_iso": "pharmacology", "pub_year": 2020, "namespace": "pharmacology"}}, 0),
            ({"text": "Doc B content", "metadata": {"document_name": "Doc B", "geography_iso": "pharmacology", "pub_year": 2015, "namespace": "pharmacology"}}, 1),
        ]
        sparse_results = [
            ({"text": "Doc B content", "metadata": {"document_name": "Doc B", "geography_iso": "pharmacology", "pub_year": 2015, "namespace": "pharmacology"}}, 0),
            ({"text": "Doc A content", "metadata": {"document_name": "Doc A", "geography_iso": "pharmacology", "pub_year": 2020, "namespace": "pharmacology"}}, 1),
        ]
    ...
    def test_rrf_merge_temporal_boost(self):
        ...
        dense_results_a = [({"text": "Doc A content", "metadata": {"document_name": "Doc A", "geography_iso": "pharmacology", "pub_year": 2022, "namespace": "pharmacology"}}, 0)]
        dense_results_b = [({"text": "Doc B content", "metadata": {"document_name": "Doc B", "geography_iso": "pharmacology", "pub_year": 2015, "namespace": "pharmacology"}}, 0)]
    ...
    def test_confidence_gate(self):
        ...
        res = self.pipeline.query("What is the mechanism of action of metformin?")
